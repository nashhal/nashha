...
أعد صياغة الخبر بصياغة صحفية عربية احترافية، مع فصل الوقائع عن الادعاءات.
...
- لا تذكر مصدرًا كصاحب الخبر إلا عند الحاجة، ويمكن إبقاء المصدر في بيانات التوثيق الداخلية.
